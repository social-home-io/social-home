...
story_repo_key: AppKey = AppKey("story_repo")
story_service_key: AppKey = AppKey("story_service")
story_retention_scheduler_key: AppKey = AppKey("story_retention_scheduler")
story_publication_service_key: AppKey = AppKey("story_publication_service")
